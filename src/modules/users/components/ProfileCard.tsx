...
const ProfileCard = ({ user, isLoading, error, refetch }: ProfileCardProps) => {
  const cardContent = () => {
      ...
      return (
        <div className='flex flex-col items-center md:flex-row md:items-start gap-8'>
          <div className='flex-shrink-0'>
            <Skeleton className='w-48 h-48 rounded-full md:rounded-lg' />
          </div>
          <div className='flex-grow flex flex-col justify-between items-center md:items-start text-center md:text-left md:relative md:h-48 w-full md:w-auto'>
    ...
    return (
      <div className='flex flex-col items-center md:flex-row md:items-start gap-8'>
        <div className='flex-shrink-0'>
          <Avatar className='w-48 h-48 md:rounded-lg'>
            <AvatarImage
        ...
        <div className='flex-grow flex flex-col justify-between items-center md:items-start text-center md:text-left md:relative md:h-48'>
  ...
  return (
    <Card className='w-full sm:shadow-lg sm:border shadow-none border-none bg-gradient-to-br'>
